...
// import { Course, SearchSuggestion, Category, Enrollment, ChapterProgress } from "@/types";
...
//   reducerPath: "api",
//   baseQuery,
//   tagTypes: ["Courses", "Categories", "Search", "Enrollments", "Progress", "Reviews"],
...
//       Course[],
//       { category?: string; q?: string; level?: string; status?: string } | void
//     >({
//       query: (params) => {
