...
//     const enable = process.env.NEXT_PUBLIC_ENABLE_CLERK === "true";
//     const key = process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY || "";
//     const looksValid = key.startsWith("pk_") && !key.includes("dummy");
//     return enable && looksValid;
//   }, []);
...
//       console.error("Checkout failed:", error?.data || error);
...
//               <p>
//                 Sign-in is required to purchase. Enable Clerk and provide a
//                 valid publishable key to proceed, or
//                 <button
...
//                     Stripe for payment processing and never store your credit
//                     card details.
//                   </p>
//                 </div>
//               </div>
...
const CheckoutPage = ({ params }: CheckoutPageProps) => {
  ...
  const { sessionId, sessionClaims } = useAuth();

  useEffect(() => {
    console.log("cliams", sessionClaims);
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-secondry-blue rounded-lg p-6 sticky top-4 space-y-6">
            ...
            <SignedOut>
              <Button className="w-full bg-dirty-grey hover:bg-dirty-grey text-white/70 py-6 px-4 text-sm font-semibold">
                Sorry , you must signin before processing
              </Button>
            </SignedOut> */}
