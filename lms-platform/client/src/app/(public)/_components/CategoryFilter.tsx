...
//       <button>Reset to All</button>
//       <div className="relative  bg-secondry-blue mb-10 py-4 px-2 rounded-lg">
//         <div className="w-full relative">
//           {showLeftArrow && (
//             <button
//               onClick={() => scroll("left")}
//               className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full cursor-pointer bg-white/70  shadow-lg flex items-center justify-center hover:bg-white transition-all duration-200`}
...
//                   className={`
//                   relative flex-shrink-0 px-6 py-2 rounded-lg font-medium text-sm
//                   transition-all duration-300 ease-out cursor-pointer border-2 border-transparent
//                   ${
//                     isSelected
//                       ? "bg-white text-secondry-blue shadow-md border-2 border-main-blue"
//                       : " text-dirty-grey shadow-sm  hover:border-dirty-grey hover:shadow-md hover:scale-102"
//                   }
//                 `}
//                 >
//                   {category.name}
...
//               className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full cursor-pointer bg-white/70 shadow-lg flex items-center justify-center hover:bg-white transition-all duration-200"
